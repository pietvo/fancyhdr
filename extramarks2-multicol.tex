...
%      \__extramarks_get_boxmarks_init:n { ##1 }
      \mult@info\tw@
        {
          \string\__extramarks_get_boxmarks_init:n { ##1 }~in~\string\prep@keptmarks\MessageBreak
...
\cs_new_protected:Npn \extramarks@multi@column@outputpage
{
  \seq_map_inline:Nn \g__extramarks_marks_seq
    {
      ...
      \mult@info\tw@
        {
          \string\__extramarks_get_boxmarks:n { ##1 }~in~\string\multi@column@out\MessageBreak
          \extramarks_show_mark:n  { g__extramarks_firstmark_##1_tl }
          \extramarks_show_mark:n  { g__extramarks_botmark_##1_tl }
       }
    }
  ...
  \seq_map_inline:Nn \g__extramarks_marks_seq
    {
      % INIT code
      \__extramarks_get_boxmarks_MC_init:n { ##1 }
      \mult@info\tw@
        {
          \string\__extramarks_get_boxmarks_MC_init:n
...
%%%%%% Misschien hier (na outputpage) topmark zetten????
...
\patchcmd{\multi@column@out} {\@makecol\@outputpage}
  ...
  {\message{Patch \string\multi@column@out\space  OK}}
